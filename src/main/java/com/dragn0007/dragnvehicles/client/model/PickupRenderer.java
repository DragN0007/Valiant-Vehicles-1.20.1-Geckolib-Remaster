...
public class PickupRenderer<T extends Pickup> extends GeoEntityRenderer<T> {

    public PickupRenderer(Context renderManager, String id) {
    super(renderManager, new PickupModel<>());
    }
