...
public class ClassicModel<T extends AbstractVehicle> extends DefaultedEntityGeoModel<T> {

    public ClassicModel() {
        super(new ResourceLocation(ValiantVehiclesMain.MODID, "classic"), false);
    }

    @Override
    public ResourceLocation getTextureResource(T animatable) {
        return ValiantVehiclesMain.id("textures/entity/classic/" + animatable.getColor().toString().toLowerCase() + ".png");
    }
