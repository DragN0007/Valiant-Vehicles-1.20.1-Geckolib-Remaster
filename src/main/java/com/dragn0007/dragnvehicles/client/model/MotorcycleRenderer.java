...
import com.dragn0007.dragnvehicles.vehicle.Motorcycle;
...
public class MotorcycleRenderer<T extends Motorcycle> extends GeoEntityRenderer<T> {

    public MotorcycleRenderer(Context renderManager, String id) {
